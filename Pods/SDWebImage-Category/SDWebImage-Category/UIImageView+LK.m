...
static char completionBlockLKey;
...
-(dispatch_block_t)completeBlock{
    dispatch_block_t completeBlock=objc_getAssociatedObject(self, &completionBlockLKey);
    if (completeBlock) {
...
-(void)setCompleteBlock:(dispatch_block_t)completeBlock{
    objc_setAssociatedObject(self, &completionBlockLKey,completeBlock, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}
